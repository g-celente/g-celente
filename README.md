...
* **Linguagens & Backend:** Node.js, TypeScript, Go (Golang), Python, Java, Bash, APIs REST & WebSockets[cite: 1].
* **Cloud & IaC:** AWS (EC2, Lambda, S3, SQS, DynamoDB, API Gateway, ECR), Terraform[cite: 1].
* **Contêineres & Orquestração:** Docker, Docker Swarm, Portainer, Kubernetes[cite: 1].
* **Observabilidade & Monitoramento:** Prometheus, Grafana, Alertmanager, Blackbox Exporter[cite: 1].
* **Bancos de Dados & Mensageria:** PostgreSQL, MongoDB, Redis, MySQL, DynamoDB, RabbitMQ, Amazon SQS[cite: 1].
* **CI/CD & Automação:** GitHub Actions, GitLab CI/CD[cite: 1].
...
<div align="left">
  <img src="https://github-readme-stats.vercel.app/api?username=g-celente&show_icons=true&theme=radical&hide_border=true" alt="Estatísticas do GitHub" />
</div>
